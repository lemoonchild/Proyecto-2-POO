            ...
            if(vista1.NombreTemporal.equals(listaDeUsuarios1.UsuariosVoluntarios.get(y).username)){
                if(listaDeUsuarios1.UsuariosVoluntarios.get(y).EventosAsignados.size()!= 0){
                    for(int b = 0; b<= listaDeUsuarios1.UsuariosVoluntarios.get(y).EventosAsignados.size()-1;b++){
                        System.out.println("\nNombre Evento: "+listaDeUsuarios1.UsuariosVoluntarios.get(y).EventosAsignados.get(b).getEventName());
                        System.out.println("Fecha: "+listaDeUsuarios1.UsuariosVoluntarios.get(y).EventosAsignados.get(b).getFecha());
                        System.out.println("Descripcion Evento: "+listaDeUsuarios1.UsuariosVoluntarios.get(y).EventosAsignados.get(b).getDescriptionEvent());
                        System.out.println("Fecha Evento: "+listaDeUsuarios1.UsuariosVoluntarios.get(y).EventosAsignados.get(b).getFecha());
                    }
                }
                if(listaDeUsuarios1.UsuariosVoluntarios.get(y).EventosAsignados.size() == 0){
